public class Game
{
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Operatives, please close your eyes! The Spymaster will now obtain the state of the board!");

        for (int i = 3; i > 0; i--) {
            System.out.println("Spymaster will obtain the state of the board in " + i + "...");
            sleep(1);
        }

        System.out.println("Spymaster be ready to record this! The board will be cleared in 10 seconds!");
